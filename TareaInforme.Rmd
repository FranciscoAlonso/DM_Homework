...
La media geometrica es baja dado que la sensibilidad es cero para varias clases. Lo que muestra un bajo rendimento general para el algoritmo en este conjunto de datos.
...
Ambos modelos presentan un buen desempeño, sin embargo, el algoritmo C5.0 supera al algoritmo RIPPER por un pequeño margen en cuanto a precisión y la media geométrica.
