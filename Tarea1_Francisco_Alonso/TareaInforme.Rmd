...
La salida del algoritmo provee un arbol de decisión que para el set de entrenamiento tiene una tasa de errores de 0% luego del proceso de boosting. También se muestra la importancia de cada atributo para el modelo construido (por razones de espacio la salida del algoritmo fue truncada e impresa).
...
La media geométrica es baja dado que la sensibilidad es cero para varias clases. Lo que muestra un bajo rendimento general para el algoritmo en este conjunto de datos.
...
Se aplica el proceso de minería de datos usando los algoritmos C5.0 y RIPPER comparándolos en base a precisión, sensibilidad y media geométrica.
...
Ambos modelos presentan un buen desempeño, sin embargo, el algoritmo C5.0 supera al algoritmo RIPPER por un pequeño margen en cuanto a precisión, sensibilidad y la media geométrica.

##Nota:

Se usó el algoritmo C5.0 en lugar de C4.5 por presentar mejoras y la conveniencia de estar disponible individualmente como un paquete para R, sin embargo, el C4.5 está presente en el paquete RWeka. Sería interesante y está como pendiente, comparar el rendimiento de ambos algoritmos en estos ejercicios.
